...
var Ng4TwitterTimelineComponent = (function () {
    ...
    Ng4TwitterTimelineComponent.prototype.ngAfterViewInit = function () {
        ...
        function (twttr) {
            ...
            window['twttr'].widgets.createTimeline({ sourceType: 'profile', screenName: _this.screenName }, nativeElement, { tweetLimit: 2 }).then(function success(embed) {
    ...
    ], Ng4TwitterTimelineComponent.prototype, "screenName", void 0);
